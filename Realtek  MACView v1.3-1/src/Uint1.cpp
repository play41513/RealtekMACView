...
bool TUSBHIDForm::FindDevice()
{
	...
	if(Tempmsg.Pos("RTL8153VC")) // 8153Chip 2015Tool
	{
	...
	else if(Tempmsg.Pos("RTL8153vC"))//8153Chip PGTOOL_v2.0.12
	{
